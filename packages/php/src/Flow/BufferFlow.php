 ...
 */
/**
 * Every Buffer node executor — the PHP twin of `BUFFER_RUNNABLE_KINDS` in
 * @particle-academy/buffer-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `BufferFlow::register($kinds, $executors)` — one call, no directory scan.
